<header class="container-fluid <?php if ($_SERVER["REQUEST_URI"] === "/"): ?> position-fixed position-md-static<?php endif; ?> z-index-2" <?php if ($_SERVER["REQUEST_URI"] === "/login" || $_SERVER["REQUEST_URI"] === "/register"): ?> hidden <?php endif; ?>>
