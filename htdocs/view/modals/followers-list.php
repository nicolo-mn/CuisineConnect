<div class="modal fade" id="followersList" tabindex="-1" aria-labelledby="followersList" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title fs-5">Followers:</h3>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <?php foreach (UserController::getInstance()->getFollowersList($templateParams["UserID"]) as $follower): ?>
